...
const GrievanceForm = () => {
  ...
  useEffect(() => {
    ...
    // If collegeName exists in query parameter, set it in formData
    if (collegeName) {
            ...
            <div className="grid grid-cols-1 gap-4">
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 block w-full px-4 py-2 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:border-yellow-500 focus:ring-yellow-500"
                />
                {errors.enrollmentUuid && <p className="text-red-500">{errors.enrollmentUuid}</p>}
              </div>
              ...
              <div>
                ...
                <div className="mt-2 space-y-2 gap-3 grid grid-cols-2">
                  <label className="inline-flex items-center">
                    <input
                      ...
                      checked={formData.typeOfGrievence.includes("Admission Related")}
                  ...
                  <label className="inline-flex items-center">
                    <input
                      ...
                      checked={formData.typeOfGrievence.includes("Anti-ragging/Posh")}
                      onChange={handleCheckboxChange}
                      className="form-checkbox h-5 w-5 text-yellow-600"
                    />
                    <span className="ml-2 text-gray-700">Anti-ragging/Posh</span>
                  </label>
                ...
                {errors.typeOfGrievence && <p className="text-red-500">{errors.typeOfGrievence}</p>}
              </div>
